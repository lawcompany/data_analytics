...
gcloud container clusters get-credentials projects/lawtalk-bigquery/locations/us-central1/clusters/us-central1-cj-airflow-d343e2c4-gke \
 --zone us-central1
...
with DAG(
    dag_id="keyword_review",
    description ="keyword with laywer review",
    start_date = datetime.datetime(2022, 5, 30, tzinfo = KST),
    ...
    #     task_id='pip_update',
    #     bash_command="pip install -U pip",
    #     dag=dag,
    # )
